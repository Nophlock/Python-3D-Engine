...
class EPA:
	...
	def barycentric(p, a, b, c):
		...
		#if v or w or u is < 0 or > 1, than we are outside the triangle 
		return v,w,u
	...
	def get_penetration_data(simplex_points, polygon_a,mat_a, polygon_b, mat_b):
		...
		v,w,u = EPA.barycentric(point_on_closest_triangle, closest_triangle_a, closest_triangle_b, closest_triangle_c)
		...
		contact_point = polygon_triangle_a_0 * u + polygon_triangle_a_1 * v + polygon_triangle_a_2 * w
